...
export default function Profile() {
  ...
  console.log("USECONTEXT",activeUser)
  return (
    <section className="p-6 ">
      ...
      <div className="Profile Card  w-96 m-auto p-8 ">
        <div className="profilePicture flex flex-col gap-2 items-center bg-white py-5 rounded-t-3xl">
          <img
            src={activeUser && activeUser.profilePic ? activeUser.profilePic : ProfilePicture}
            alt="profilePicture"
        ...
        <div className="flex flex-col text-white gap-3 bg-deep-orange-800 bg-opacity-20 p-3 rounded-b-xl ">
          ...
          <p><span className="font-bold italic">Name</span> : {activeUser?.name}</p>
          <p><span className="font-bold italic">Email</span> : {activeUser?.email}</p>
