    ...
    <section className="p-6">
      <div className="params  md:w-[90%] m-auto bg-blue-gray-50 p-6 rounded-t-xl border-t-8 border-t-deep-orange-500 md:flex ">
        <div className="border-deep-orange-500 border-l-8 ml-3 text-left p-2">
          <p className="header   text-black italic font-bold">
          ...
          <ul className="flex justify-center space-x-2">
            {Array.from(
              ...
              (_, i) => (
                <li
                  key={i}
                  className={`cursor-pointer inline-block px-3 py-2 text-sm rounded-md transition duration-300 ${
                    currentPage === i + 1
                      ? "bg-deep-orange-500 text-white font-bold"
